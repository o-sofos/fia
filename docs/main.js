...
);`),B("How automatic keying works: Objects/arrays get stable internal IDs via WeakMap (no memory leaks). Primitives are keyed by type:value. Custom keyFn takes precedence when provided.","info")}),W("When to Use Custom Keys",()=>{q("Automatic keying works great in most cases, but provide a custom keyFn when:"),U(`// ✅ Automatic keying works:
