var y=void 0,o=0,G0=0,k=void 0;function r(z){if(y)z.subs.add(y),y.deps.add(z)}function a(z){z.version=++o;let F=[...z.subs];for(let f of F)if(G0>0){if(!k)k=new Set;k.add(f)}else f.execute()}function l(z){for(let F of z.deps)F.subs.delete(z);z.deps.clear()}function b(z){let F=!0,f={execute(){if(!F)return;l(f);let Z=y;y=f;try{z()}finally{y=Z}},deps:new Set,cleanup(){F=!1,l(f)}};return f.execute(),()=>f.cleanup()}function E0(z){let F={version:o,subs:new Set},f=z,Z=function(X){if(arguments.length>0){if(!Object.is(f,X))f=X,a(F);return}return r(F),f};return Object.defineProperty(Z,"value",{get(){return r(F),f},set(X){if(!Object.is(f,X))f=X,a(F)}}),Z[Q0]=!0,Z.peek=()=>f,Z}function d0(z){let F={version:o,subs:new Set},f,Z=-1,X={execute(){F.version=++o;let H=[...F.subs];for(let G of H)if(G0>0){if(!k)k=new Set;k.add(G)}else G.execute()},deps:new Set,cleanup(){l(X)}},Y=()=>{l(X);let H=y;y=X;try{let G=z();if(!Object.is(f,G))f=G;Z=F.version}finally{y=H}};Y();let J=function(){if(Z!==F.version)Y();return r(F),f};return Object.defineProperty(J,"value",{get(){return J()}}),J[Q0]=!0,J.peek=()=>{if(Z!==F.version)Y();return f},J}var W0=Symbol("reactive-proxy"),c=Symbol("raw");function k0(z){return z!==null&&typeof z==="object"&&W0 in z}function H0(z){let F=new Map,f=new WeakMap;function Z(Y){let J=F.get(Y);if(!J)J={version:0,subs:new Set},F.set(Y,J);return J}return new Proxy(z,{get(Y,J,H){if(J===c||J==="$raw")return Y;if(J===W0)return!0;let G=Z(J);r(G);let j=Reflect.get(Y,J,H);if(j!==null&&typeof j==="object"&&!k0(j)){let M=f.get(j);if(!M)M=H0(j),f.set(j,M);return M}return j},set(Y,J,H,G){let j=Reflect.get(Y,J,G),M=H!==null&&typeof H==="object"&&c in H?H[c]:H,T=Array.isArray(Y)&&J==="length";if(Object.is(j,M)&&!T)return!0;if(Reflect.set(Y,J,M,G),j!==null&&typeof j==="object")f.delete(j);let n=F.get(J);if(n)a(n);return!0},has(Y,J){if(J===W0||J===c||J==="$raw")return!0;return Reflect.has(Y,J)},ownKeys(Y){return Reflect.ownKeys(Y)},getOwnPropertyDescriptor(Y,J){return Reflect.getOwnPropertyDescriptor(Y,J)},deleteProperty(Y,J){let H=Reflect.has(Y,J),G=Reflect.deleteProperty(Y,J);if(H&&G){let j=F.get(J);if(j)a(j)}return G}})}function I(z,...F){if(typeof z==="function")return d0(z);if(z!==null&&typeof z==="object")return H0(z);return E0(z)}var Q0=Symbol("signal");function V(z){return typeof z==="function"&&z[Q0]===!0}var t=[];function C(z){t.push(z)}function h(){t.pop()}function $(){return t[t.length-1]??document.body}var b0=new Set(["click","dblclick","input","change","keydown","keyup","keypress","mousedown","mouseup","mouseover","mouseout","mousemove","touchstart","touchend","touchmove","focusin","focusout","submit"]),e=new WeakMap,K0=new Set;function m0(z){let{target:F,type:f}=z;while(F){let Z=e.get(F);if(Z&&Z[f]){if(Object.defineProperty(z,"currentTarget",{configurable:!0,value:F}),Z[f](z),z.cancelBubble)break}F=F.parentElement}}function z0(z,F,f){if(b0.has(F)){if(!K0.has(F))document.addEventListener(F,m0,{capture:!1,passive:!1}),K0.add(F);let Z=e.get(z);if(!Z)Z={},e.set(z,Z);Z[F]=f}else z.addEventListener(F,f)}if(typeof window<"u")window.__eventHandlerMap=e;function D(z){return(F,f)=>{let Z=document.createElement(z),X,Y;if(F===void 0);else if(N(F))Y=F;else if(_(F)){if(X=F,f!==void 0)Y=f}if(X)A(Z,X);let J=[],H=(G)=>J.push(G);if(Y){let G=document.createDocumentFragment();C(G);try{Y(Z,H)}finally{h()}Z.appendChild(G)}if($().appendChild(Z),J.length>0)requestAnimationFrame(()=>{for(let G of J)G()});return Z}}function W(z){return(F,f,Z)=>{let X=document.createElement(z),Y,J,H;if(F===void 0);else if(m(F)){if(Y=F,f===void 0);else if(N(f))H=f;else if(_(f)){if(J=f,Z!==void 0)H=Z}}else if(N(F))H=F;else if(_(F)){if(J=F,f!==void 0&&N(f))H=f}if(Y!==void 0)S(X,Y);if(J)A(X,J);let G=[],j=(M)=>G.push(M);if(H){let M=document.createDocumentFragment();C(M);try{H(X,j)}finally{h()}X.appendChild(M)}if($().appendChild(X),G.length>0)requestAnimationFrame(()=>{for(let M of G)M()});return X}}function p(z){return(F,f,Z)=>{let X=document.createElement(z),Y,J,H,G;if(F===void 0);else if(m(F)){if(Y=F,f===void 0);else if(L0(f))J=f;else if(N(f))G=f;else if(_(f)){if(H=f,Z!==void 0)G=Z}}else if(N(F))G=F;else if(_(F)){if(H=F,f!==void 0&&N(f))G=f}if(Y!==void 0)S(X,Y);if(J)z0(X,"click",J);if(H)A(X,H);let j=[],M=(T)=>j.push(T);if(G){let T=document.createDocumentFragment();C(T);try{G(X,M)}finally{h()}X.appendChild(T)}if($().appendChild(X),j.length>0)requestAnimationFrame(()=>{for(let T of j)T()});return X}}function R(z){return(F)=>{let f=document.createElement(z);if(F)A(f,F);return $().appendChild(f),f}}function j0(){return(z,F,f)=>{let Z=document.createElement("img"),X,Y,J;if(z===void 0);else if(typeof z==="string"&&M0(z)){if(X=z,F===void 0);else if(typeof F==="string"){if(Y=F,f!==void 0)J=f}else if(_(F))J=F}else if(_(z))J=z;if(X!==void 0)Z.src=X;if(Y!==void 0)Z.alt=Y;if(J)A(Z,J);return $().appendChild(Z),Z}}function $0(){return(z,F,f)=>{let Z=document.createElement("a"),X,Y,J,H;if(z===void 0);else if(typeof z==="string"&&I0(z)){if(X=z,F===void 0);else if(m(F)){if(Y=F,f!==void 0)J=f}else if(_(F))J=F}else if(N(z))H=z;else if(_(z)){if(J=z,F!==void 0&&N(F))H=F}if(X!==void 0)Z.href=X;if(Y!==void 0)S(Z,Y);if(J)A(Z,J);let G=[],j=(M)=>G.push(M);if(H){let M=document.createDocumentFragment();C(M);try{H(Z,j)}finally{h()}Z.appendChild(M)}if($().appendChild(Z),G.length>0)requestAnimationFrame(()=>{for(let M of G)M()});return Z}}function m(z){return typeof z==="string"||typeof z==="number"||V(z)&&(typeof z.peek()==="string"||typeof z.peek()==="number")}function L0(z){if(typeof z!=="function")return!1;if(V(z))return!1;return z.length<=1}function I0(z){if(typeof z!=="string")return!1;return/^(\/|#|https?:|mailto:|tel:|\.\.?\/)/.test(z)}function M0(z){if(typeof z!=="string")return!1;return/^(\/|https?:|data:image\/|blob:|\.\.?\/)/.test(z)||/\.(jpg|jpeg|png|gif|svg|webp|avif|ico|bmp)$/i.test(z)}var U0={className:"class",htmlFor:"for",httpEquiv:"http-equiv",acceptCharset:"accept-charset",accessKey:"accesskey",autoCapitalize:"autocapitalize",autoComplete:"autocomplete",autoFocus:"autofocus",autoPlay:"autoplay",colSpan:"colspan",contentEditable:"contenteditable",crossOrigin:"crossorigin",dateTime:"datetime",defaultChecked:"checked",defaultValue:"value",encType:"enctype",enterKeyHint:"enterkeyhint",fetchPriority:"fetchpriority",formAction:"formaction",formEnctype:"formenctype",formMethod:"formmethod",formNoValidate:"formnovalidate",formTarget:"formtarget",hrefLang:"hreflang",inputMode:"inputmode",isMap:"ismap",maxLength:"maxlength",minLength:"minlength",noModule:"nomodule",noValidate:"novalidate",playsInline:"playsinline",readOnly:"readonly",referrerPolicy:"referrerpolicy",rowSpan:"rowspan",srcDoc:"srcdoc",srcLang:"srclang",srcSet:"srcset",tabIndex:"tabindex",useMap:"usemap",itemScope:"itemscope",itemType:"itemtype",itemId:"itemid",itemProp:"itemprop",itemRef:"itemref",popoverTarget:"popovertarget",popoverTargetAction:"popovertargetaction",shadowRootMode:"shadowrootmode",shadowRootDelegatesFocus:"shadowrootdelegatesfocus",shadowRootClonable:"shadowrootclonable",shadowRootSerializable:"shadowrootserializable",controlsList:"controlslist",disablePictureInPicture:"disablepictureinpicture",disableRemotePlayback:"disableremoteplayback",allowFullscreen:"allowfullscreen",attributionSrc:"attributionsrc",elementTiming:"elementtiming"};function S0(z){return["value","checked","selected","muted","currentTime","volume","indeterminate","defaultValue","defaultChecked","textContent","innerText"].includes(z)}function v0(z,F,f){switch(F){case"value":if("value"in z)z.value=String(f??"");break;case"checked":if("checked"in z)z.checked=Boolean(f);break;case"selected":if("selected"in z)z.selected=Boolean(f);break;case"muted":if("muted"in z)z.muted=Boolean(f);break;case"currentTime":if("currentTime"in z)z.currentTime=Number(f??0);break;case"volume":if("volume"in z)z.volume=Number(f??1);break;case"indeterminate":if("indeterminate"in z)z.indeterminate=Boolean(f);break;case"defaultValue":if("defaultValue"in z)z.defaultValue=String(f??"");break;case"defaultChecked":if("defaultChecked"in z)z.defaultChecked=Boolean(f);break;case"textContent":z.textContent=String(f??"");break;case"innerText":z.innerText=String(f??"");break}}function w0(z,F,f){if(F==="class"||F==="className"||F==="classList")p0(z,f);else if(F==="style")i0(z,f);else if(S0(F))v0(z,F,f);else if(typeof f==="boolean")if(f)z.setAttribute(U0[F]??F,"");else z.removeAttribute(U0[F]??F);else z.setAttribute(U0[F]??F,String(f))}function A(z,F){for(let f in F){let Z=F[f];if(Z===null||Z===void 0)continue;if(f.startsWith("on")&&typeof Z==="function"){let X=f.slice(2).toLowerCase();z0(z,X,Z)}else if(V(Z))b(()=>w0(z,f,Z.value));else w0(z,f,Z)}}function p0(z,F){if(typeof F==="string")z.className=F;else if(Array.isArray(F))z.className=F.filter(Boolean).join(" ");else if(typeof F==="object"&&F!==null){let f=!1;for(let X in F)if(V(F[X])){f=!0;break}let Z=()=>{let X=[];for(let Y in F){let J=F[Y];if(V(J)?J.value:J)X.push(Y)}z.className=X.join(" ")};if(f)b(Z);else Z()}}function g0(z){return typeof z==="object"&&z!==null&&"type"in z&&typeof z.type==="string"}function q0(z){switch(z.type){case"rgb":return z.a!==void 0?`rgba(${z.r}, ${z.g}, ${z.b}, ${z.a})`:`rgb(${z.r}, ${z.g}, ${z.b})`;case"hsl":return z.a!==void 0?`hsla(${z.h}, ${z.s}%, ${z.l}%, ${z.a})`:`hsl(${z.h}, ${z.s}%, ${z.l}%)`;case"hwb":return z.a!==void 0?`hwb(${z.h} ${z.w}% ${z.b}% / ${z.a})`:`hwb(${z.h} ${z.w}% ${z.b}%)`;case"oklch":return z.a!==void 0?`oklch(${z.l}% ${z.c} ${z.h} / ${z.a})`:`oklch(${z.l}% ${z.c} ${z.h})`;case"lab":return z.alpha!==void 0?`lab(${z.l}% ${z.a} ${z.b} / ${z.alpha})`:`lab(${z.l}% ${z.a} ${z.b})`;case"lch":return z.alpha!==void 0?`lch(${z.l}% ${z.c} ${z.h} / ${z.alpha})`:`lch(${z.l}% ${z.c} ${z.h})`;case"oklab":return z.alpha!==void 0?`oklab(${z.l}% ${z.a} ${z.b} / ${z.alpha})`:`oklab(${z.l}% ${z.a} ${z.b})`;case"hex":return z.value;case"color":{let F=z.components.join(" ");return z.alpha!==void 0?`color(${z.space} ${F} / ${z.alpha})`:`color(${z.space} ${F})`}case"color-mix":{let F=typeof z.color1==="object"?q0(z.color1):z.color1,f=typeof z.color2==="object"?q0(z.color2):z.color2,Z=z.percentage1!==void 0?`${z.percentage1}%`:"",X=z.percentage2!==void 0?`${z.percentage2}%`:"";return`color-mix(${z.method}, ${F} ${Z}, ${f} ${X})`}}}function _0(z){if(z===null||z===void 0)return"";if(g0(z))return q0(z);return String(z)}function N0(z,F,f){if(F.startsWith("--")){z.setProperty(F,f);return}if(F.startsWith("webkit")||F.startsWith("moz")||F.startsWith("ms")||F.startsWith("o")){let Z=F.replace(/([A-Z])/g,"-$1").toLowerCase();z.setProperty(Z,f);return}try{z[F]=f}catch{z.setProperty(F,f)}}function i0(z,F){if(typeof F==="string")z.setAttribute("style",F);else if(typeof F==="object"&&F!==null){let f=!1;for(let Z in F)if(V(F[Z])){f=!0;break}if(f)b(()=>{for(let Z in F){let X=F[Z],Y=V(X)?X.value:X;N0(z.style,Z,_0(Y))}});else for(let Z in F){let X=F[Z];N0(z.style,Z,_0(X))}}}function S(z,F){if(V(F))b(()=>{z.textContent=String(F.value)});else z.textContent=String(F)}function _(z){return typeof z==="object"&&z!==null&&!V(z)&&!Array.isArray(z)}function N(z){return typeof z==="function"&&!V(z)}var P=$0(),D0=j0(),F0=p("button"),O1=p("summary"),A1=p("option"),B1=p("optgroup"),R0=W("h1"),O0=W("h2"),g=W("h3"),i=W("h4"),V1=W("h5"),T1=W("h6"),v=W("p"),Q=W("div"),P1=W("article"),f0=W("section"),y1=W("aside"),A0=W("header"),B0=W("footer"),C1=W("main"),h1=W("blockquote"),s1=W("figcaption"),Z0=W("pre"),x1=W("address"),w=W("span"),E1=W("strong"),d1=W("em"),k1=W("small"),b1=W("mark"),m1=W("code"),S1=W("samp"),v1=W("kbd"),p1=W("var"),g1=W("i"),i1=W("b"),u1=W("u"),n1=W("s"),c1=W("del"),o1=W("ins"),r1=W("sub"),a1=W("sup"),l1=W("abbr"),t1=W("cite"),e1=W("dfn"),z5=W("q"),F5=W("time"),f5=W("data"),Z5=W("bdi"),J5=W("bdo"),X5=W("ruby"),Y5=W("rp"),W5=W("rt"),Q5=W("label"),U5=W("legend"),q5=W("output"),D5=W("caption"),G5=W("td"),H5=W("th"),E=W("li"),K5=W("dd"),L5=W("dt"),j5=W("title"),M5=R("input"),$5=R("br"),I5=R("hr"),w5=R("meta"),_5=R("link"),N5=R("area"),R5=R("base"),O5=R("col"),A5=R("embed"),B5=R("source"),V5=R("track"),T5=R("wbr"),J0=D("ul"),P5=D("ol"),y5=D("menu"),C5=D("table"),h5=D("tbody"),s5=D("thead"),x5=D("tfoot"),E5=D("tr"),d5=D("colgroup"),k5=D("form"),b5=D("fieldset"),m5=D("details"),S5=D("dialog"),V0=D("nav"),v5=D("figure"),p5=D("select"),g5=D("datalist"),i5=D("dl"),u5=D("audio"),n5=D("video"),c5=D("picture"),o5=D("iframe"),r5=D("object"),a5=D("canvas"),l5=D("map"),t5=D("body"),e5=D("head"),zz=D("html"),Fz=D("hgroup"),fz=D("template"),Zz=D("slot"),Jz=D("noscript"),Xz=D("script"),Yz=D("style"),Wz=D("textarea"),Qz=D("meter"),Uz=D("progress"),qz=D("search");var T0=()=>V0({class:"container animate-fade-up delay-100",style:{display:"flex",justifyContent:"space-between",alignItems:"center",height:"100px"}},()=>{Q({style:{fontSize:"1.5rem",fontWeight:"700",display:"flex",alignItems:"center",gap:"0.5rem",cursor:"pointer"}},()=>{w({style:{color:"var(--mongo-green)"},textContent:"fia"})}),Q({style:{display:"flex",gap:"2rem",alignItems:"center"}},()=>{P({href:"#features",style:{fontWeight:"500"},textContent:"Features"}),P({href:"#docs",style:{fontWeight:"500"},textContent:"Docs"}),P({href:"https://github.com/o-sofos/fia",target:"_blank",class:"btn btn-outline",style:{padding:"0.5rem 1.25rem",fontSize:"0.9rem"},textContent:"GitHub"})})});var P0=()=>A0({class:"container",style:{padding:"var(--spacing-xl) 0",textAlign:"center",maxWidth:"900px",position:"relative"}},()=>{R0({style:{fontSize:"4.5rem",lineHeight:"1.1",marginBottom:"var(--spacing-md)",fontWeight:"800",letterSpacing:"-0.02em",position:"relative",zIndex:"1"}},()=>{Q({textContent:"Build High-Performance UIs"}),Q({class:"text-gradient",textContent:"Without the Virtual DOM"})}),v({style:{fontSize:"1.25rem",color:"var(--text-secondary)",marginBottom:"var(--spacing-lg)",maxWidth:"800px",margin:"0 auto var(--spacing-lg)",lineHeight:"1.6",position:"relative",zIndex:"1"},textContent:"Fia is a lightweight, framework-agnostic library designed for high-performance UI development. By leveraging fine-grained signals, Fia bypasses the overhead of a Virtual DOM to update the DOM directly and precisely."}),Q({style:{display:"flex",gap:"1rem",justifyContent:"center",marginTop:"var(--spacing-lg)",position:"relative",zIndex:"1"}},()=>{F0({class:"btn btn-primary",style:{padding:"1rem 2rem",fontSize:"1.1rem"},textContent:"Get Started"}),P({href:"https://github.com/o-sofos/fia",target:"_blank",class:"btn btn-outline",style:{padding:"1rem 2rem",fontSize:"1.1rem"},textContent:"View Source"})}),Q({class:"animate-float",style:{position:"absolute",top:"10%",left:"5%",width:"60px",height:"60px",borderRadius:"1rem",background:"linear-gradient(135deg, var(--mongo-green), var(--mongo-forest))",opacity:"0.2",boxShadow:"0 10px 30px rgba(0,237,100,0.2)",zIndex:"0",transform:"rotate(45deg)"}}),Q({class:"animate-float-delayed",style:{position:"absolute",bottom:"10%",right:"5%",width:"80px",height:"80px",borderRadius:"50%",border:"2px solid var(--mongo-green)",opacity:"0.1",zIndex:"0"}}),Q({class:"animate-float",style:{position:"absolute",top:"15%",right:"15%",width:"20px",height:"20px",borderRadius:"50%",background:"var(--mongo-green)",opacity:"0.2",boxShadow:"0 0 20px var(--mongo-green)",zIndex:"0",animationDelay:"1s"}}),Q({class:"animate-float-delayed",style:{position:"absolute",bottom:"25%",left:"10%",width:"120px",height:"120px",borderRadius:"50%",background:"radial-gradient(circle, var(--mongo-green) 0%, transparent 70%)",opacity:"0.1",zIndex:"0",filter:"blur(20px)",animationDelay:"2s"}}),Q({class:"animate-float",style:{position:"absolute",top:"45%",right:"8%",width:"40px",height:"40px",border:"1px solid rgba(255,255,255,0.1)",borderRadius:"8px",transform:"rotate(15deg) translateZ(-20px)",opacity:"0.3",zIndex:"0",animationDelay:"3s"}})});function X0(z,F=10){let f,Z=()=>{f=z.getBoundingClientRect(),z.style.transition="transform 0.1s ease-out"},X=(J)=>{if(!f)f=z.getBoundingClientRect();let H=J.clientX-f.left,G=J.clientY-f.top,j=f.width/2,M=f.height/2,T=(G-M)/M*-F,n=(H-j)/j*F;z.style.transform=`
            perspective(1000px)
            rotateX(${T}deg)
            rotateY(${n}deg)
            scale3d(1.02, 1.02, 1.02)
        `},Y=()=>{z.style.transition="transform 0.5s ease-out",z.style.transform="perspective(1000px) rotateX(0) rotateY(0) scale3d(1, 1, 1)"};return z.addEventListener("mouseenter",Z),z.addEventListener("mousemove",X),z.addEventListener("mouseleave",Y),()=>{z.removeEventListener("mouseenter",Z),z.removeEventListener("mousemove",X),z.removeEventListener("mouseleave",Y)}}var O=(z)=>{$().appendChild(document.createTextNode(z))},y0=()=>Q({class:"container animate-fade-up delay-200",style:{margin:"var(--spacing-xl) auto",maxWidth:"800px"}},()=>{Q({style:{background:"var(--mongo-forest)",borderRadius:"1rem",padding:"2rem",boxShadow:"0 20px 50px rgba(0,0,0,0.5)",border:"1px solid var(--mongo-slate)",fontFamily:"'JetBrains Mono', monospace",fontSize:"0.95rem",overflow:"hidden",lineHeight:"1.6",transformStyle:"preserve-3d"}},(z)=>{X0(z,5),Q({style:{display:"flex",gap:"0.5rem",marginBottom:"1.5rem",opacity:"0.7",transform:"translateZ(20px)"}},()=>{Q({style:{width:"12px",height:"12px",borderRadius:"50%",background:"#ff5f56"}}),Q({style:{width:"12px",height:"12px",borderRadius:"50%",background:"#ffbd2e"}}),Q({style:{width:"12px",height:"12px",borderRadius:"50%",background:"#27c93f"}})});let F=(Y)=>w({style:{color:"var(--syntax-keyword)"},textContent:Y}),f=(Y)=>w({style:{color:"var(--syntax-function)"},textContent:Y}),Z=(Y)=>w({style:{color:"var(--syntax-string)"},textContent:Y}),X=(Y)=>w({style:{color:"var(--syntax-comment)"},textContent:Y});Z0({style:{transform:"translateZ(40px)"}},()=>{Q(()=>{F("import"),O(" { $, div, button } "),F("from"),Z(' "fia"'),O(";")}),O(" "),Q(()=>{F("const"),O(" count = "),f("$"),O("(0);")}),O(" "),Q(()=>{f("div"),O("(() => {")}),Q({style:{paddingLeft:"1.5rem"}},()=>{f("button"),O("("),Z('"Increment"'),O(", () => count.value++);")}),O(" "),Q({style:{paddingLeft:"1.5rem"}},()=>{X("// Updates are surgical - no VDOM diffing")}),Q({style:{paddingLeft:"1.5rem"}},()=>{f("div"),O("("),f("$"),O("(() => "),Z("`Count: ${count.value}`"),O("));")}),Q({textContent:"});"})})})});var x=(z,F,f)=>Q({style:{padding:"2rem",background:"rgba(255,255,255,0.03)",borderRadius:"1rem",border:"1px solid rgba(255,255,255,0.05)",transition:"transform 0.1s ease-out",transformStyle:"preserve-3d"}},(Z)=>{X0(Z,15),Q({style:{fontSize:"2.5rem",marginBottom:"1rem",transform:"translateZ(20px)"},textContent:f}),g({style:{fontSize:"1.25rem",marginBottom:"0.75rem",color:"var(--mongo-green)",fontWeight:"600",transform:"translateZ(10px)"},textContent:z}),v({style:{color:"var(--text-secondary)",lineHeight:"1.6",transform:"translateZ(5px)"},textContent:F})}),C0=()=>f0({id:"features",class:"container",style:{display:"grid",gridTemplateColumns:"repeat(auto-fit, minmax(300px, 1fr))",gap:"2rem",marginBottom:"var(--spacing-xl)",paddingTop:"var(--spacing-lg)"}},()=>{x("Zero Virtual DOM","Fia updates the DOM directly. No diffing, no overhead, no reconciliation cost. Just pure performance.","⚡"),x("Fine-Grained Reactivity","Signals track dependencies automatically. Only what changes updates.","\uD83C\uDFAF"),x("Type Safe","Built with TypeScript, for TypeScript. Enjoy full autocomplete and type inference for all HTML attributes and events.","\uD83D\uDEE1️"),x("Accessibility First","WCAG compliance built-in. Advanced ARIA types with literal values and role-specific attribute suggestions.","♿"),x("Zero Dependencies","No npm packages. No supply chain risk. No version conflicts. Just pure JavaScript.","\uD83D\uDCE6"),x("Tiny Bundle","Only ~6KB gzipped. Smaller than most utility libraries. Fast to download, fast to parse.","⚖️"),x("Event Delegation","Single delegated listener per event type.","\uD83C\uDFAA"),x("Fragment Batching","Automatic DocumentFragment batching. No more intermediate nodes or layout thrashing.","\uD83D\uDE80")});var h0=()=>B0({style:{borderTop:"1px solid var(--mongo-slate)",marginTop:"auto",padding:"var(--spacing-lg) 0",background:"rgba(0,0,0,0.2)"}},()=>{Q({class:"container",style:{textAlign:"center",color:"var(--text-secondary)",fontSize:"0.9rem"}},()=>{Q({style:{marginBottom:"1rem"},textContent:"© 2026 Fia Framework. Open Source under MIT License."})})});var d=(z)=>{$().appendChild(document.createTextNode(z))},u0=(z)=>{z.split(/(\/\/.*|\".*?\"|\bconst\b|\bimport\b|\bfrom\b|\bfunction\b|\breturn\b|\bdiv\b|\bbutton\b|\bh1\b|\bp\b|\bul\b|\bli\b|\binput\b|\bspan\b|\bmap\b|\bfilter\b|\bconsole\b|\blog\b|\btrue\b|\bfalse\b|\bif\b|\belse\b|\bShow\b|\bEach\b|\bMatch\b)/g).forEach((f)=>{if(f.startsWith("//"))w({style:{color:"var(--syntax-comment)"},textContent:f});else if(f.startsWith('"')||f.startsWith("'")||f.startsWith("`"))w({style:{color:"var(--syntax-string)"},textContent:f});else if(["const","import","from","function","return","if","else","true","false"].includes(f))w({style:{color:"var(--syntax-keyword)"},textContent:f});else if(["div","button","h1","p","ul","li","input","span","console","log","map","filter","Show","Each","Match"].includes(f))w({style:{color:"var(--syntax-function)"},textContent:f});else d(f)})},q=(z)=>Q({class:"code-block animate-fade-up",style:{background:"var(--mongo-forest)",borderRadius:"0.75rem",padding:"1.5rem",margin:"1.5rem 0",border:"1px solid var(--mongo-slate)",boxShadow:"0 10px 30px rgba(0,0,0,0.3)",fontFamily:"'JetBrains Mono', monospace",fontSize:"0.9rem",lineHeight:"1.6",overflow:"hidden"}},()=>{Q({style:{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:"1rem"}},()=>{Q({style:{display:"flex",gap:"0.5rem",opacity:"0.6"}},()=>{Q({style:{width:"10px",height:"10px",borderRadius:"50%",background:"#ff5f56"}}),Q({style:{width:"10px",height:"10px",borderRadius:"50%",background:"#ffbd2e"}}),Q({style:{width:"10px",height:"10px",borderRadius:"50%",background:"#27c93f"}})});let F=I(!1);F0({textContent:I(()=>F.value?"Copied!":"Copy"),style:{background:"transparent",border:"1px solid var(--mongo-slate)",color:I(()=>F.value?"var(--mongo-green)":"var(--text-secondary)"),borderRadius:"4px",padding:"2px 8px",fontSize:"0.75rem",cursor:"pointer",transition:"all 0.2s",opacity:"0.8"},onclick:()=>{navigator.clipboard.writeText(z),F.value=!0,setTimeout(()=>F.value=!1,2000)}})}),Z0({style:{margin:"0",overflowX:"auto"}},()=>{u0(z)})}),B=(z,F,f)=>{f0({id:F,class:"animate-fade-up",style:{marginBottom:"var(--spacing-xl)",scrollMarginTop:"120px"}},()=>{Q({style:{display:"flex",alignItems:"center",gap:"0.75rem",marginBottom:"1.5rem"}},()=>{Q({style:{width:"4px",height:"32px",background:"var(--mongo-green)",borderRadius:"2px"}}),O0({style:{fontSize:"2rem",color:"var(--mongo-white)",letterSpacing:"-0.5px"},textContent:z})}),f()})},K=(z,F)=>{Q({style:{marginBottom:"2.5rem"}},()=>{g({style:{fontSize:"1.5rem",marginBottom:"1rem",color:"var(--mongo-green)"},textContent:z}),F()})},L=(z,F)=>{Q({style:{marginBottom:"1.5rem"}},()=>{i({style:{fontSize:"1.2rem",marginBottom:"0.75rem",color:"var(--mongo-white)",fontWeight:"600"},textContent:z}),F()})},U=(z)=>v({style:{marginBottom:"1rem",lineHeight:"1.8",color:"var(--text-secondary)",fontSize:"1.05rem"}},()=>d(z)),u=(z)=>J0({style:{marginLeft:"1.5rem",marginBottom:"1.5rem",color:"var(--text-secondary)",lineHeight:"1.8"}},()=>{z.forEach((F)=>E({textContent:F}))}),s=(z,F="info")=>Q({style:{background:F==="warning"?"rgba(255, 189, 46, 0.1)":"rgba(0, 237, 100, 0.05)",borderLeft:`4px solid ${F==="warning"?"#ffbd2e":"var(--mongo-green)"}`,padding:"1rem",borderRadius:"0 0.5rem 0.5rem 0",marginBottom:"1.5rem",color:F==="warning"?"#ffbd2e":"var(--mongo-green)"}},()=>d(z)),Y0=[{id:"intro",title:"Introduction"},{id:"why-fia",title:"Why Fia?"},{id:"getting-started",title:"Getting Started"},{id:"element-api",title:"Element API"},{id:"element-factory-types",title:"Element Factory Types"},{id:"reactivity",title:"Reactivity"},{id:"immutability",title:"Immutability"},{id:"control-flow",title:"Control Flow"},{id:"components",title:"Components"},{id:"svg",title:"SVG"},{id:"performance",title:"Performance"},{id:"examples",title:"Examples"}],n0=()=>{let z=I("intro"),F=()=>{let f=window.scrollY+150;for(let Z=Y0.length-1;Z>=0;Z--){let X=document.getElementById(Y0[Z].id);if(X&&X.offsetTop<=f){z.value=Y0[Z].id;break}}};if(typeof window<"u")setTimeout(()=>{window.addEventListener("scroll",F),F()},0);return Q({class:"toc-container",style:{position:"sticky",top:"120px",height:"fit-content",maxHeight:"calc(100vh - 140px)",overflowY:"auto",paddingRight:"1rem",width:"220px",flexShrink:"0"}},()=>{Q({style:{borderLeft:"2px solid var(--mongo-slate)",paddingLeft:"1rem"}},()=>{g({style:{fontSize:"0.875rem",color:"var(--text-secondary)",marginBottom:"1rem",textTransform:"uppercase",letterSpacing:"0.05em",fontWeight:"600"}}),J0({style:{listStyle:"none",padding:"0",margin:"0"}},()=>{Y0.forEach((f)=>{E({style:{marginBottom:"0.5rem"}},()=>{P({href:`#${f.id}`,style:{color:I(()=>z.value===f.id?"var(--mongo-green)":"var(--text-secondary)"),textDecoration:"none",fontSize:"0.875rem",display:"block",padding:"0.25rem 0",transition:"color 0.2s",fontWeight:I(()=>z.value===f.id?"600":"400"),borderLeft:I(()=>z.value===f.id?"2px solid var(--mongo-green)":"2px solid transparent"),paddingLeft:"0.5rem",marginLeft:"-0.5rem"},textContent:f.title,onclick:(Z)=>{Z.preventDefault();let X=document.getElementById(f.id);if(X){let J=X.offsetTop-100;window.scrollTo({top:J,behavior:"smooth"}),z.value=f.id}}})})})})})})},s0=()=>Q({id:"docs",class:"container",style:{display:"flex",gap:"3rem",maxWidth:"1400px",margin:"0 auto",paddingBottom:"var(--spacing-xl)",paddingLeft:"2rem",paddingRight:"2rem"}},()=>{n0(),Q({style:{flex:"1",minWidth:"0",maxWidth:"800px"}},()=>{Q({style:{display:"flex",gap:"0.5rem",marginBottom:"2rem",marginTop:"1rem"}},()=>{P({href:"https://jsr.io/@fia/core",target:"_blank"},()=>{D0({src:"https://jsr.io/badges/@fia/core",alt:"jsr-badge"})}),P({href:"https://jsr.io/@fia/core",target:"_blank"},()=>{D0({src:"https://jsr.io/badges/@fia/core/score",alt:"score-badge"})})}),B("Introduction","intro",()=>{U("Fia is a lightweight, framework-agnostic library designed for high-performance UI development. By leveraging fine-grained signals, Fia bypasses the overhead of a Virtual DOM to update the DOM directly and precisely.")}),B("Why Fia?","why-fia",()=>{U("While modern web development is often bogged down by complex reconciliation processes, Fia focuses on surgical precision."),J0({style:{marginLeft:"1.5rem",marginBottom:"1.5rem",color:"var(--text-secondary)"}},()=>{E({style:{marginBottom:"0.5rem"}},()=>{w({style:{color:"var(--mongo-white)",fontWeight:"600"},textContent:"True Fine-Grained Reactivity: "}),d("Only the parts of the DOM that actually change are updated. No component re-renders, no VDOM diffing—just targeted updates.")}),E({style:{marginBottom:"0.5rem"}},()=>{w({style:{color:"var(--mongo-white)",fontWeight:"600"},textContent:"End-to-End Type Safety: "}),d("Built from the ground up with TypeScript, Fia ensures your signals and effects are predictable and catch errors at compile time, not runtime.")}),E({style:{marginBottom:"0.5rem"}},()=>{w({style:{color:"var(--mongo-white)",fontWeight:"600"},textContent:"Zero-Abstraction Feel: "}),d("Fia stays out of your way. It provides the reactive primitives you need to build powerful interfaces without forcing a heavy framework architecture on you.")}),E({style:{marginBottom:"0.5rem"}},()=>{w({style:{color:"var(--mongo-white)",fontWeight:"600"},textContent:"Minimal Footprint: "}),d("Designed for developers who value bundle size and execution speed, Fia provides a lean reactive core that scales from small widgets to full-scale applications.")})})}),B("Getting Started","getting-started",()=>{K("Prerequisites",()=>{U("Fia is compatible with any modern JavaScript runtime."),u(["Node.js (v18.0.0+)","Bun (v1.0.0+)","Deno (v1.30.0+)"])}),K("Installation",()=>{U("Fia is published on JSR. Install it using your preferred package manager:"),Q({style:{marginBottom:"1rem"}},()=>{i({style:{color:"var(--mongo-white)",marginBottom:"0.5rem"},textContent:"Deno"}),q("deno add jsr:@fia/core")}),Q({style:{marginBottom:"1rem"}},()=>{i({style:{color:"var(--mongo-white)",marginBottom:"0.5rem"},textContent:"Bun"}),U('1. Create .npmrc file: echo "@jsr:registry=https://npm.jsr.io" > .npmrc'),U("2. Install (aliased as 'fia'):"),q("bun add fia@npm:@jsr/fia__core")}),Q({style:{marginBottom:"1rem"}},()=>{i({style:{color:"var(--mongo-white)",marginBottom:"0.5rem"},textContent:"Node.js (npm/yarn/pnpm)"}),q("npx jsr add @fia/core")}),s("The 'bun' command above automatically aliases the package to 'fia'. For Node.js/Deno, mapping to 'fia' in package.json/deno.json is recommended for cleaner imports.","info")}),K("Updating",()=>{U("To update to the latest version, run the installation command again (or use your package manager's update command)."),q(`# Deno
...
});`)})})})})});var x0=()=>{let z=I(0),F=I(0),f=I(0);return document.addEventListener("mousemove",(Z)=>{z.value=Z.clientX,F.value=Z.clientY,f.value=1}),document.addEventListener("mouseout",()=>{f.value=0}),Q({style:{position:"fixed",top:"0",left:"0",width:"400px",height:"400px",borderRadius:"50%",background:"radial-gradient(circle, rgba(0, 237, 100, 0.15) 0%, transparent 60%)",transform:I(()=>`translate(${z.value-200}px, ${F.value-200}px)`),pointerEvents:"none",zIndex:"9999",mixBlendMode:"screen",filter:"blur(30px)",opacity:I(()=>f.value.toString()),transition:"opacity 0.3s ease",willChange:"transform"}})};var c0=()=>Q({id:"landing-page"},()=>{x0(),T0(),P0(),y0(),C0(),s0(),h0()});c0();
