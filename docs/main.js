...
});`}]),N("Elements: article, section, nav, form, ul, ol, table, canvas, video, and more.")}),B("Text Elements",()=>{H("Optimized for elements that commonly hold text content. Click each tab to see different ways to create the same heading:"),$0([{label:"Empty",code:`// Empty element
...
});`}]),N("Elements: h1-h6, p, div, span, label, li, td, th, strong, em, code, and more.")}),B("Interactive Elements",()=>{H("Special factories for interactive elements with convenient text + click handler shorthand:"),$0([{label:"Text + Click ",code:`// Text + click handler shorthand
...
});`)})})})})});var xf=()=>J({id:"landing-page"},()=>{jf(),Xf(),Yf(),sf(),Af(),If(),Mf()});xf();
