import type { AriaRole, FlickAriaAttributes } from "../core/aria";
import type { DomEvents } from "../core/events";
...
export type ChildrenCallback<E extends HTMLElement> = (el: E) => void;
 ...
 */
export interface TypedDOMTokenList<T extends string> extends Omit<DOMTokenList, "contains" | "add" | "remove" | "toggle" | "replace"> {
 ...
 */
export type SmartElement<K extends keyof HTMLElementTagNameMap, P> = Omit<E<K>, "classList"> & P & {
